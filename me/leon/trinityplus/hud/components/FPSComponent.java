...
public class FPSComponent extends Component
{
    public FPSComponent() {
        ...
        this.visible = true;
        this.x = 0.0f;
        this.y = this.res.getScaledHeight() / 2.0f;
    }
    
    public void render() {
        this.drawBackground();
        FontUtil.drawString("FPS: " + ChatFormatting.WHITE + Minecraft.getDebugFPS(), this.x + 1.0f, this.y, this.getTextColor());
    }
    
    public float width() {
        return FontUtil.getStringWidth("FPS: " + ChatFormatting.WHITE + Minecraft.getDebugFPS()) + 3.0f;
    }
