...
package me.leon.trinityplus.gui.particle;
...
public class ParticleSystem
{
    ...
    public void render() {
        ...
        for (final Particle particle : this.particleList) {
            GL11.glColor4f(ClickGUI.particleColor.getR() / 255.0f, ClickGUI.particleColor.getG() / 255.0f, ClickGUI.particleColor.getB() / 255.0f, particle.getAlpha() / 255.0f);
            ...
            this.drawLine(particle.getX(), particle.getY(), nearestParticle.getX(), nearestParticle.getY(), ClickGUI.particleColor.getR() / 255.0f, ClickGUI.particleColor.getG() / 255.0f, ClickGUI.particleColor.getB() / 255.0f, alpha);
        }
        GL11.glPushMatrix();
